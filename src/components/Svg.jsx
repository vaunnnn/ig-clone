...
export const SearchSVG = () => {
    return (
        <svg xmlns="http://www.w3.org/2000/svg" width={20} height={20} viewBox="0 0 24 24">
            <path fill="none" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" d="m21 21l-4.343-4.343m0 0A8 8 0 1 0 5.343 5.343a8 8 0 0 0 11.314 11.314" strokeWidth={1}></path>
        </svg>
    )
}
    ...
    return (
        <svg xmlns="http://www.w3.org/2000/svg" width={20} height={16} viewBox="0 0 16 16">
            <g fill="currentColor">
                ...
                <path d="M9 6a3 3 0 1 0 0-6a3 3 0 0 0 0 6M7 3a2 2 0 1 1 4 0a2 2 0 0 1-4 0"></path>
            </g>
        </svg>
    )
}
...
export const MessagesSVG = () => {
    return (
        <svg xmlns="http://www.w3.org/2000/svg" width={20} height={20} viewBox="0 0 24 24">
            <path fill="currentColor" d="m20.34 9.32l-14-7a3 3 0 0 0-4.08 3.9l2.4 5.37a1.06 1.06 0 0 1 0 .82l-2.4 5.37A3 3 0 0 0 5 22a3.14 3.14 0 0 0 1.35-.32l14-7a3 3 0 0 0 0-5.36Zm-.89 3.57l-14 7a1 1 0 0 1-1.35-1.3l2.39-5.37a2 2 0 0 0 .08-.22h6.89a1 1 0 0 0 0-2H6.57a2 2 0 0 0-.08-.22L4.1 5.41a1 1 0 0 1 1.35-1.3l14 7a1 1 0 0 1 0 1.78"></path>
        </svg>
    )
}
